<template>
  <div class="filter-sidebar">
    ...
    <div class="filter-group">
      ...
      <input type="number" v-model="filters.yearFrom" placeholder="від">
      <input type="number" v-model="filters.yearTo" placeholder="до">
    </div>

    <div class="filter-group">
      <label>Ціна:</label>
      <input type="number" v-model="filters.priceFrom" placeholder="від">
      <input type="number" v-model="filters.priceTo" placeholder="до">
    </div>
